...
class ListingTabs extends \Magento\Catalog\Block\Product\AbstractProduct
{
	...
	public function _getCfg($attr = null , $data = null)
	{
        ...
        /* parametros por configuracion backend */
        if(isset($this->_config['widget'])){
            $this->_config['title'] = $this->_scopeConfig->getValue('home_carousels/widget'.$this->_config['widget'].'/title',\Magento\Store\Model\ScopeInterface::SCOPE_STORE,$this->_storeCode);
            $this->_config['under_price'] = $this->_scopeConfig->getValue('home_carousels/widget'.$this->_config['widget'].'/under_price',\Magento\Store\Model\ScopeInterface::SCOPE_STORE,$this->_storeCode);
            $this->_config['category_tabs'] = $this->_scopeConfig->getValue('home_carousels/widget'.$this->_config['widget'].'/category_tabs',\Magento\Store\Model\ScopeInterface::SCOPE_STORE,$this->_storeCode);
            $this->_config['order_by'] = $this->_scopeConfig->getValue('home_carousels/widget'.$this->_config['widget'].'/order_by',\Magento\Store\Model\ScopeInterface::SCOPE_STORE,$this->_storeCode);
            $this->_config['order_dir'] = $this->_scopeConfig->getValue('home_carousels/widget'.$this->_config['widget'].'/order_dir',\Magento\Store\Model\ScopeInterface::SCOPE_STORE,$this->_storeCode);
            $this->_config['limitation'] = $this->_scopeConfig->getValue('home_carousels/widget'.$this->_config['widget'].'/limitation',\Magento\Store\Model\ScopeInterface::SCOPE_STORE,$this->_storeCode);
        }
