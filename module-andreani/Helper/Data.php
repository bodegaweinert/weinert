...
class Data extends AbstractHelper
{
    ...
    /**
     * @description Obtiene la configuración del modo de impresión de la guía.
     * @return mixed
     */
    public function getImpresionGuiasConfig()
    {
        return $this->_scopeConfig->getValue('shipping/andreani_configuracion/impresion_guia');
    }
    ...
    public function getProvincias(){
        $regionCollection = $this->_countryFactory->loadByCode("AR")->getRegions();
        $regions = $regionCollection->loadData()->toOptionArray(true);

        return $regions;
    }

    public function getClienteRecargo($clienteProvincia){
        foreach($this->getProvinciasRecargo() as $provinciaRecargo){
            if($clienteProvincia == $provinciaRecargo){
                return true;
            }
        }
    ...
    public function getProvinciasRecargo(){
        $provincias = $this->_scopeConfig->getValue('shipping/andreani_configuracion/recargo_provincia');
    ...
    public function getProvinciasRecargoImporte(){
        if($this->_scopeConfig->getValue('shipping/andreani_configuracion/recargo_provincia_importe')){
            return (float)$this->_scopeConfig->getValue('shipping/andreani_configuracion/recargo_provincia_importe');
        }
     ...
     * @return mixed
     */
    public function getSeguimientoHabilitado()
    {
        return $this->_scopeConfig->getValue('shipping/andreani_configurable_cron/active');
    }

    public function getEmailsReporte()
    {
        return $this->_scopeConfig->getValue('shipping/andreani_configurable_cron/email_to');
    }

    public function getDiasAviso()
    {
        $dias[] = $this->_scopeConfig->getValue('shipping/andreani_configurable_cron/dias');
        $dias[] = $this->_scopeConfig->getValue('shipping/andreani_configurable_cron/dias2');
        return $dias;
    }
}
