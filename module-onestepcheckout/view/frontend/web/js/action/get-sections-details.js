...
define(
    ...
    function (
        ...
        function setSectionsDetails (sectionsDetails) {
            ...
            if (firstProcessing){
                if (quote.totals().shipping_amount != undefined && quote.shippingMethod()){
                    if (quote.totals().shipping_amount != quote.shippingMethod().price_excl_tax){
                        shippingMethod.call().selectShippingMethod(quote.shippingMethod());
                    }
                }
