<?php
namespace Aheadworks\OneStepCheckout\Controller\Customer\Address;
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->_eventManager->dispatch(
                'customer_edit_address_from_account_before_save',
                [
                    'address'     => $address
                ]
            );
            ...
            $this->_eventManager->dispatch(
                'customer_edit_address_from_account_after_save',
                [
                    'address'     => $address
                ]
            );
