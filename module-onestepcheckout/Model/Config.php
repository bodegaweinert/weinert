...
class Config
{
    ...
    /**
     * Configuration path to business fields customization config
     */
    const XML_PATH_BUSINESS_INFORMATION_FORM_CUSTOMIZATION = 'aw_osc/business_information/fields_customization';

    /**
     * Configuration path to business fields customization config
     */
    const XML_PATH_BUSINESS_INFORMATION_ENABLED = 'aw_osc/business_information/enabled';
    ...
    /**
     * Check if business information is enabled
     *
     * @return bool
     */
    public function isBusinessInformationEnabled()
    {
        return $this->scopeConfig->isSetFlag(
            self::XML_PATH_BUSINESS_INFORMATION_ENABLED,
            ScopeInterface::SCOPE_STORE
        );
    }
    ...
    public function getAddressFormConfig($addressType)
    {
        if ($addressType == 'business') {
            $path = self::XML_PATH_BUSINESS_INFORMATION_FORM_CUSTOMIZATION;
        } else {
