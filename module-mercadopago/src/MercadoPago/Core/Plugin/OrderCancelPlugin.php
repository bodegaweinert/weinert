...
class OrderCancelPlugin
{
    ...
    {
        $cancellationAvailable = $this->dataHelper->isCancellationAvailable();
        ...
        if ($cancellationAvailable && $paymentID == null){
    ...
    protected function checkCancellationData($orderStatus, $orderPaymentStatus)
    {
        ...
        if (!($orderStatus == 'processing' || $orderStatus == 'pending' || $orderStatus == 'pending_payment' || $orderStatus == 'contabilium_pending')) {
