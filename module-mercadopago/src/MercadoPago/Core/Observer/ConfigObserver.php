    ...
    implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        ...
        $this->checkCancellationAvailable();
    }

    public function checkCancellationAvailable(){
        ...
        if ($cancellationAvailable && $automaticCancellationAvailable){
            ...
            $cancellationCronFrequency = $this->_scopeConfig->getValue(
                \MercadoPago\Core\Helper\Data::XML_PATH_CANCELLATION_CRON_FREQUENCY,
                \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE,
                $this->_scopeCode
            );

            $this->_saveWebsiteConfig(\MercadoPago\Core\Helper\Data::XML_PATH_CANCELLATION_CRON_PATH, $cancellationCronFrequency);
            $this->_saveWebsiteConfig(\MercadoPago\Core\Helper\Data::XML_PATH_CANCELLATION_CRON_MODEL, null);
        } else {
            $this->_saveWebsiteConfig(\MercadoPago\Core\Helper\Data::XML_PATH_CANCELLATION_CRON_PATH, null);
            $this->_saveWebsiteConfig(\MercadoPago\Core\Helper\Data::XML_PATH_CANCELLATION_CRON_MODEL, null);
        }
    }
