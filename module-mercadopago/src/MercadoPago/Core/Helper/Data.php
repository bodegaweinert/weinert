    ...
    extends \Magento\Payment\Helper\Data
{
    ...
    /**
     *path to mercadopago cancellation config
     */
    const XML_PATH_CANCELLATION_AVAILABLE           = "payment/mercadopago/cancellation_available";
    const XML_PATH_CANCELLATION_AUTOMATIC_AVAILABLE = "payment/mercadopago/cancel_automatically_orders";
    const XML_PATH_LIMIT_ORDER_DURATION             = "payment/mercadopago/pending_orders_limit_duration";
    const XML_PATH_CANCELLATION_CRON_FREQUENCY      = "payment/mercadopago/cancellation_cron_frequency";
    const XML_PATH_CANCELLATION_CRON_PATH           = "crontab/default/jobs/mp_cancel_order/schedule/cron_expr";
    const XML_PATH_CANCELLATION_CRON_MODEL          = "crontab/default/jobs/mp_cancel_order/run/model";


    /**
     *path to mercadopago notification waiting time
     */
    const XML_PATH_NOTIFICATION_WAITING_TIME = 'payment/mercadopago/notification_waiting_time';
    /**
    ...
    public function isCancellationAvailable()
    {
        return $this->scopeConfig->getValue(self::XML_PATH_CANCELLATION_AVAILABLE, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    }
    ...
    public function getNotificationWaitingTime(){
        $value = $this->scopeConfig->getValue(\MercadoPago\Core\Helper\Data::XML_PATH_NOTIFICATION_WAITING_TIME, \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        return (int) $value;
    }
}
