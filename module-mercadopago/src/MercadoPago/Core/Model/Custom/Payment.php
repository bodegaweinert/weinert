    ...
    implements GatewayInterface
{
     ...
     * @param \MercadoPago\Core\Helper\StatusUpdate                $statusUpdateHelper
    ...
    public function __construct(
        ...
        \MercadoPago\Core\Helper\StatusUpdate $statusUpdateHelper,
        \Magento\Framework\App\RequestInterface $request)
    {
        ...
        $this->_statusUpdateHelper = $statusUpdateHelper;
    }
        ...
        if (!empty($infoInstance->getAdditionalInformation('second_card_token'))) {
            ...
            if ($response) {
                ...
                if (isset($payment['payer']['identification']['type'])){
                    ...
                    $infoInstance->setAdditionalInformation('payer_identification_type', "");
                }
                ...
                if (isset($payment['payer']['identification']['number'])){
                    ...
                    $infoInstance->setAdditionalInformation('payer_identification_number', "");
                }

                //$stateObject->setStatus($this->_statusUpdateHelper->getStatusOrder($payment['status'],$payment['status_detail'],false));
                //$stateObject->setState($this->_statusUpdateHelper->_getAssignedState($stateObject->getStatus()));
...
//        return false;
    ...
    public function preparePostPayment($usingSecondCardInfo = null)
    {
        ...
        /*custom entry*/
        $preference['payment_method'] = 'credit_card';
