    ...
    extends \Magento\Quote\Model\Quote\Address\Total\AbstractTotal
{
    ...
    protected function _getFacturaAFeeAmount()
    {
        $quote = $this->_checkoutSession->getQuote();
        $totals = $quote->getShippingAddress()->getTotals();
        $discount = (isset($totals['factura_a_fee'])) ? $totals['factura_a_fee']['value'] : 0;
    ...
    protected function _getFinanceCostAmount()
    {
        ...
        $facturaAFeeAmount = $this->_getFacturaAFeeAmount();
        
        $balance = $totalAmount - $initAmount - $discountAmount - $taxAmount - $facturaAFeeAmount;
